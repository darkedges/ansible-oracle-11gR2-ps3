# http://www.techpaste.com/2013/09/simple-wlst-script-start-stop-monitor-check-status-managed-servers-progress-bar-weblogic-server/
...
def connectToDomain():
    try:
         connect(wls_uid, wls_password, 't3://'+wls_adminServer+':7001');
